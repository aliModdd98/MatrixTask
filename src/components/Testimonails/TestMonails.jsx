...
function TestMonails() {
  const TestPerson = [
    {
      ...
      job: "Ceo & Founder",
      profile:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, unde molestiae. Reprehenderit veniam blanditiis vero repudiandae officiis obcaecati ipsam.",
      imgProfile: img1,
    },
    {
      name: "Sara Willson",
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      const nextIndex =
        (activeButtonIndex + 1) % Math.ceil(TestPerson.length / 2);
  ...
  return (
    <div className="container testContainer">
      <Title
        title="TESTIMONIALS"
        desc="Magnam dolores commodi suscipit eum quidem consectetur velit"
      />
